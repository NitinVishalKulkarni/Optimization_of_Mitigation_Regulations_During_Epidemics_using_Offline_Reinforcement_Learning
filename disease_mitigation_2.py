...
class DiseaseMitigation(gym.Env):
    ...
    def __init__(self, environment_type):
        ...
        self.observation_space = spaces.Discrete(6)  # This defines that there are 3 states in the environment.
        ...
        self.death_rate = 0.00575360283440081
        self.recovery_rate = 0.0346
    ...
    def reset(self):
        ...
        observation = [self.number_of_healthy_people / self.population,
                       self.number_of_infected_people / self.population, self.number_of_dead_people / self.population,
                       self.number_of_recovered_people / self.population, scaled_gdp / 100, self.action_counter]
    ...
    def step(self, action):
        ...
        if action == 0:  # This action represents not going into lockdown.
            ...
            self.number_of_dead_people += np.random.binomial(n=self.number_of_infected_people, p=self.death_rate)
            self.number_of_infected_people = self.population - self.number_of_healthy_people - \
                                             self.number_of_dead_people
            number_of_people_that_recover = np.random.binomial(n=self.number_of_infected_people, p=self.recovery_rate)
        ...
        observation = [self.number_of_healthy_people / self.population,
                       self.number_of_infected_people / self.population, self.number_of_dead_people / self.population,
                       self.number_of_recovered_people / self.population, scaled_gdp / 100, action_counter]
    ...
    def render(self, mode='human'):
        ...
        # plt.plot(self.number_of_recovered_people_list, label='Number of Recovered Individuals')
        # plt.plot(self.number_of_dead_people_list, label='Number of Dead Individuals')
        # plt.legend()
        # plt.xlabel('Day')
...
# axes[0].plot(random_agent.number_of_recovered_people_list, label='Number of Recovered People')
# axes[0].plot(random_agent.number_of_dead_people_list, label='Number of Dead People')
...
# axes[1].plot(dqn_agent.number_of_recovered_people_list, label='Number of Recovered People')
# axes[1].plot(dqn_agent.number_of_dead_people_list, label='Number of Dead People')
...
# axes[2].plot(double_dqn_agent.number_of_recovered_people_list, label='Number of Recovered People')
# axes[2].plot(double_dqn_agent.number_of_dead_people_list, label='Number of Dead People')
...
# axes[3].plot(awr_agent.number_of_recovered_people_list, label='Number of Recovered People')
# axes[3].plot(awr_agent.number_of_dead_people_list, label='Number of Dead People')
